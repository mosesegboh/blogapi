...
class VerificationRequestRepository extends ServiceEntityRepository
{
    ...
    public function add(VerificationRequest $entity, bool $flush = false): void
    {
...
//    }
    ...
    public function findOneById($value): ?VerificationRequest
    {
        return $this->createQueryBuilder('v')
            ->andWhere('v.id = :val')
            ->setParameter('val', $value)
    ...
    public function findOneByUserId($value): ?VerificationRequest
    {
        return $this->createQueryBuilder('v')
            ->andWhere('v.user = :val')
            ->setParameter('val', $value)
